 ...
 * */
  ...
  * 
	...
	require_once('MysqlConezion.class.php');
	$bdd = new Consulta();
	$sql = "UPDATE  User_login  SET username ='Rolando" .
	 "',email='null".
	 "',password='linux".
	 "',estado=1" .
 ...
 class Consulta
 {
	...
	public function GetConsulta($query)
	{
		...
		//se le pude mejorar el resultado de la query
		//tomo nota
		$this->result = mysql_query($query, $this->conexion);
		if(!$this->result) 
			return $this->VerificarError(2);
